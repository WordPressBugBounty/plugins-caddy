...
<form name="caddy-form" id="caddy-display-form" method="post" action="">
	...
	<div class="cc-settings-container">
		<h2><span class="section-icons"><img src="<?php echo plugin_dir_url( CADDY_PLUGIN_FILE ) . 'admin/img/icon-display.svg'; ?>" /></span>&nbsp;<?php echo esc_html( __( 'Display Behavior', 'caddy' ) ); ?></h2>
		<p><?php esc_html_e('Select what Caddy should do after a product is added to cart or saved for later.', 'caddy-premium'); ?></p>
